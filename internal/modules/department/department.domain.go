...
type CreateRequest struct {
	...
	HeadEmployeeID *uuid.UUID `json:"head_employee_id,omitempty" binding:"omitempty,uuid"`
}
...
type AssignHeadRequest struct {
	HeadEmployeeID *uuid.UUID `json:"head_employee_id" binding:"omitempty,uuid"` // nil = remove head
}
