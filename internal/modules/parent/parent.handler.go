...
func (h *Handler) Routes(r *gin.RouterGroup) {
	parent := r.Group(constants.ApiParentPath)
	parent.Use(middleware.AuthCheckMiddleware(&h.config.JWT))
	{
		parent.GET("/:id", h.getByID)
		parent.GET("/", h.list)
		parent.PUT("/:id", h.update)
		parent.DELETE("/:id", h.delete)
	}
}
...
func (h *Handler) getByID(c *gin.Context) {
	...
	response.Success(c, resp, "Parent retrieved successfully")
}
...
func (h *Handler) list(c *gin.Context) {
	...
	response.SuccessPaginated(c, resp, pagination.NewMeta(total, p), "Parents listed successfully")
}
...
func (h *Handler) update(c *gin.Context) {
	...
	response.Success(c, resp, "Parent updated successfully")
}
...
func (h *Handler) delete(c *gin.Context) {
	...
	response.Success[any](c, nil, "Parent deleted successfully")
}
